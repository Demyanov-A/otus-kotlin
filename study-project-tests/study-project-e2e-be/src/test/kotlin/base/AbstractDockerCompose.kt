package ru.demyanovaf.kotlin.taskManager.e2e.be.base
 ...
 * dockerComposeNames - имена docker-compose файлов (относительно study-project-acceptance/docker-compose)
 */
